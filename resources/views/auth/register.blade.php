...
<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="p-8 space-y-10">
        ...
        <div class="space-y-6">
            <h5 class="text-md font-semibold text-gray-800 border-b pb-2">Minat & Bakat</h5>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-1">
                    <label class="text-sm font-semibold text-gray-700">Hobi</label>
                    <input type="text" name="hobby" value="{{ old('hobby') }}" placeholder="Contoh: Membaca, Coding"
                        class="w-full px-4 py-2.5 rounded-xl border-gray-200 focus:border-blue-500 focus:ring-blue-500 transition shadow-sm">
                </div>
                <div class="space-y-1">
                    <label class="text-sm font-semibold text-gray-700">Mata Pelajaran Favorit</label>
                    <input type="text" name="favorite_subject" value="{{ old('favorite_subject') }}" placeholder="Contoh: Matematika"
                        class="w-full px-4 py-2.5 rounded-xl border-gray-200 focus:border-blue-500 focus:ring-blue-500 transition shadow-sm">
                </div>
            </div>
        </div>
        ...
        <div class="space-y-6">
            <h5 class="text-md font-semibold text-gray-800 border-b pb-2">Kontak & Alamat</h5>
            <div class="space-y-5">
                <div class="space-y-1">
        ...
        <div class="space-y-6">
            <h5 class="text-md font-semibold text-gray-800 border-b pb-2">Sosial Media</h5>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-1">
                    <label class="text-sm font-semibold text-gray-700">Username Instagram</label>
                    <input type="text" name="instagram" value="{{ old('instagram') }}" placeholder="@username"
                        class="w-full px-4 py-2.5 rounded-xl border-gray-200 focus:border-blue-500 focus:ring-blue-500 transition shadow-sm">
                </div>
                <div class="space-y-1">
                    <label class="text-sm font-semibold text-gray-700">Username TikTok</label>
        ...
        <div class="space-y-6">
            <h5 class="text-md font-semibold text-gray-800 border-b pb-2">Akun Siswa</h5>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-1">
        ...
        <div class="flex items-center justify-between pt-6 border-t border-gray-100">
            <a href="{{ route('login') }}" class="text-sm font-semibold text-gray-600 hover:text-blue-600 transition">
                Sudah punya akun? Login
            </a>
            <button type="submit" class="px-8 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold shadow-md shadow-indigo-100 transition transform active:scale-95">
