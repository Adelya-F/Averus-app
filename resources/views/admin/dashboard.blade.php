...
<body class="bg-gray-100 min-h-screen flex">
    ...
    <nav class="flex-1 p-4 space-y-3">
       ...
       <a href="#" class="flex justify-between items-center px-4 py-2 rounded-lg hover:bg-blue-700">
        <span>Inbox</span>
        <span class="bg-yellow-400 text-blue-900 text-[10px] font-bold px-2 py-0.5 rounded-full">12</span>
    </a>
    </nav>
