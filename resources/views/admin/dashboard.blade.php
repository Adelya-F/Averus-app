...
<a href="{{ route('admin.siswa.index') }}" 
   class="flex items-center gap-3 px-4 py-2 rounded-lg transition {{ request()->routeIs('admin.siswa.*') ? 'bg-blue-700 text-white shadow-md' : 'text-blue-100 hover:bg-blue-700' }}">
...
<a href="{{ route('admin.kelas.index') }}" 
   class="flex items-center gap-3 px-4 py-2 rounded-lg transition {{ request()->routeIs('admin.kelas.*') ? 'bg-blue-700 font-semibold shadow-inner' : 'hover:bg-blue-700' }}">
...
<a href="{{ route('admin.jadwal.index') }}" 
   class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-blue-700 transition {{ request()->routeIs('admin.jadwal.*') ? 'bg-blue-700 font-semibold shadow-inner' : '' }}">
